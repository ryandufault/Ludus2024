class Jeu7 extends Phaser.Scene {
  ...
  create() {
    ...
    this.ghost3 = this.physics.add
      .sprite(506, 239, "ghost")
      .setScale(2)
      .setDepth(10)
      .setAlpha(0);
    this.ghost3.body.setSize(16, 16).setOffset(8, 16);
