class Faq extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("esc2", "./assets/images/faq/esc2.png");
  ...
  create() {
    ...
    this.header = this.add.image(0, 100, "header").setOrigin(0, 0).setAlpha(0);
    this.f2 = this.add.image(0, 0, "f2").setOrigin(0, 0).setAlpha(0);
    this.f = this.add.image(0, 20, "f").setOrigin(0, 0).setAlpha(0);
    this.esc = this.add.image(0, 20, "esc").setOrigin(0, 0).setAlpha(0);
    this.esc2 = this.add.image(30, -30, "esc2").setOrigin(0, 0).setAlpha(0);
    this.tweens.add({
      targets: this.header,
      alpha: 1,
      y: 0,
