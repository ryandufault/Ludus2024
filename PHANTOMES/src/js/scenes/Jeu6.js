class Jeu6 extends Phaser.Scene {
  ...
  create() {
    ...
    this.cameras.main.pan(8, 235, 2000);
    this.walkSpeed = 100;
    this.runSpeed = 165;
    ...
    let timelineg3 = this.add.timeline();
    timelineg3.add({
      at: 0,
      tween: {
        targets: this.ghost3,
  ...
  wallborders() {
    ...
    this.obstacle9 = this.add.rectangle(448, 225, 15, 31).setOrigin(0, 0);
